...
import Detail from '../contentScreen/Detail';
    ...
    renderLabel={({route, focused, color}) => (
      <View
        style={{
          ...
          width:route.title==="Incidents"?responsiveWidth(19):
          route.title==="Notes"?responsiveWidth(12):
          route.title==="Vitals"?responsiveWidth(12):
          responsiveWidth(14),
        }}>
        <Text
          style={{
